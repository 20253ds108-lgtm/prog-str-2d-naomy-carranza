...
public class Main {
    public static int contarrango=0;
    public static int nonumero=0;
    public static void main(String[] args) throws Exception {
        ...
        while(intentos<limiteIntentos){
            ...
            intentos++;
            if(numero == secreto){
                System.out.println("las veces que te pasaste de rango fueron: "+contarrango);
                System.out.println("las veces que ingresaste un dato no numerico fueron: "+nonumero);
                System.out.println("¡Ganaste! "+intentos);
