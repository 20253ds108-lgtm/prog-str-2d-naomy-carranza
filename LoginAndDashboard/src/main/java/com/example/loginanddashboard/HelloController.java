            ...
            if (correo.contains("@") && correo.contains(".")){
                if (nombre.length() > 3){
                    if (pass.length() >= 6){
                        ...
                        botonDeBienvenida.setText("la contraseña es muy corta");
                    }
                }else {
                    botonDeBienvenida.setText("nombre no valido");
                }
            }else {
                botonDeBienvenida.setText("correo no valido");
            }
        }else {
            botonDeBienvenida.setText("no se puede dejar vacio");
        }
    }
}
